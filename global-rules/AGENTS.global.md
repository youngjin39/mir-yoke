# Global AGENTS.md — shared baseline coding rules (Codex mirror)

Codex-CLI mirror of `CLAUDE.global.md`. Copy or merge into your own global `~/.codex/AGENTS.md`.
Same rules, applied by Codex CLI.
