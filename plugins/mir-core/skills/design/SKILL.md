...
When the repository provides a design schema, record structured output through its optional `materials`, `decision_surface`, `open_decisions`, `authority_notes`, and `migration_closure` fields.
