...
# ADR-33 — Design Complete Gate Hook

## Context

The public template needs a stable reference record for ADR-33 so applied-state verification can confirm the baseline catalog is complete.
