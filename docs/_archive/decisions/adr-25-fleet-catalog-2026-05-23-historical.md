...
# ADR-25 — Fleet Catalog

## Context

The public template needs a stable reference record for ADR-25 so applied-state verification can confirm the baseline catalog is complete.
