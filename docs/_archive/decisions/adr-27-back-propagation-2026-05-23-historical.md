...
# ADR-27 — Back-Propagation

## Context

The public template needs a stable reference record for ADR-27 so applied-state verification can confirm the baseline catalog is complete.
