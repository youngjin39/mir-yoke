...
# ADR-42 — Verify Template Applied-State

## Context

The public template needs a stable reference record for ADR-42 so applied-state verification can confirm the baseline catalog is complete.
