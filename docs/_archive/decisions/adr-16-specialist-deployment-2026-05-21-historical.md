...
# ADR-16 — Specialist Deployment

## Context

The public template needs a stable reference record for ADR-16 so applied-state verification can confirm the baseline catalog is complete.
