...
# ADR-12 — Prompt Cache Reshape Lane

## Context

The public template needs a stable reference record for ADR-12 so applied-state verification can confirm the baseline catalog is complete.
