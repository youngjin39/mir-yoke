...
# ADR-23 — Active Family Dogfooding Exception

## Context

The public template needs a stable reference record for ADR-23 so applied-state verification can confirm the baseline catalog is complete.
