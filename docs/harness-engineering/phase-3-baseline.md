...
> Purpose: Define the baseline memory and context contracts used by the harness.

## 0.5 Design Goals

- Keep the public template aligned with the your-harness baseline for phase 3.
