...
> Purpose: Define the common intake path, declaration rules, and routing entrypoint.

## 0.5 Design Goals

- Keep the public template aligned with the your-harness baseline for phase 1.
