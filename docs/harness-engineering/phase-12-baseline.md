...
# Phase 12 — Template Lifecycle

> Purpose: Describe versioning, migration, and template maintenance responsibilities.

## 0.5 Design Goals

- Keep the public template aligned with the your-harness baseline for phase 12.
