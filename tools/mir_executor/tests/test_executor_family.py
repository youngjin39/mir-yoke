...
Six base tests + two P2.2 registry tests covering:
  ...
  7. P2.2: claude-starter slug exists in _FAMILY_PATHS
     (17 entries after mir-yoke + musinsa-brand land)
...
def test_claude_starter_compile_skips_with_message(capsys):
    ...
    assert "P2.2" in result.profile_status, "skip message must reference P2.2 for traceability"
